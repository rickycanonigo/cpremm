    ...
    return (
      <div id="record-form" className="entry-form">
			<table cellspacing="0" border="0" style={{width: "100%", margin:"auto"}}>
				...
				<tbody><tr>
					<td style={{borderBottom: "1px solid #000000"}} colSpan="11" height="81" align="center" valign="middle"><b><font face="Arial Black" color="#000000">KNOWLEDGE MANAGEMENT - INFORMATION AND COMMUNICATION TECHNOLOGY IT CORRECTIVE &amp; PREVENTIVE MAINTENANCE MONITORING RECORD QUARTERLY CY:2020</font></b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"><b><i><font face="Lucida Sans Unicode">Serial Numbers</font></i></b></td>
				</tr>
				<tr>
					<td style={{border: "1px solid #000000"}} colSpan="3" height="33" align="left" valign="middle"></td>
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"></td>
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"></td>
				</tr>
				<tr>
				...
				<tr>
					<td style={{border: "1px solid #000000"}} colSpan="3" height="37" align="left" valign="middle"></td>
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"></td>
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"></td>
				</tr>
				<tr>
					<td style={{border: "1px solid #000000"}} colSpan="3" height="38" align="left" valign="middle"></td>
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"></td>
					<td style={{border: "1px solid #000000"}} colSpan="4" align="center" valign="middle"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" valign="middle"></td>
					<td align="left" valign="middle"></td>
					<td style={{borderTop: "1px solid #000000"}} colSpan="5" align="right" valign="middle"><font face="Lucida Sans Unicode" color="#000000">DOH-RO13-KM-ICT-QSOP-02 Form3 Rev 3</font></td>
				</tr>
			</tbody></table>
      </div>
