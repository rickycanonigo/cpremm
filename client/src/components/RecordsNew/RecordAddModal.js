...
class RecordAddModal extends React.Component {
  ...
  componentDidUpdate (){
    console.log("----------->>>>>>>>>>>;;;;;;;;");
    console.log(this.props.recordNew.submitted);
    console.log(this.props.modal);
    console.log(this.state.currentForm);
    console.log(this.props.recordNew.submitted && this.props.modal && this.state.currentForm != 1);
    if (this.props.recordNew.submitted && this.props.modal && this.state.currentForm != 1){
  ...
  render () {
    ...
    }else if (this.state.currentForm < 7 && this.state.currentForm > 1) {
      butts.push({type: "BACK", callback: () => {
        this.setState({currentForm: this.state.currentForm-1})
      }});
