...
class HfPersonnelClass {
	...
	save() {
		return new Promise((resolve, reject) => {
			try {
				var newHfPersonnel = new HfPersonnel({
					province: this.province,
					facility: this.facility,
					hfPersonnelID: this.hfPersonnelID,
					category: this.category,
					categoryID: this.categoryID,
					categoryIDNumber: this.categoryIDNumber,
					philHealthID: this.philHealthID,
					pwdID: this.pwdID,
					name: this.name,
					...
					covidDetails: this.covidDetails,
					allergy: this.allergy,
					comorbidities: this.comorbidities,
					pregStatus: this.pregStatus,
	...
	static getHfPersonnels(page = 1, count = 10, filter = {}, sort = { 'hfPersonnelID': 1 }, select = []) {
		return new Promise((resolve, reject) => {
			HfPersonnel
				.find(filter)
				.sort(sort)
...
module.exports = HfPersonnelClass;